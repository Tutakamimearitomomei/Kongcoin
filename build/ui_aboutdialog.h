...
"Copyright &copy; 2011-YYYY The Kongcoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Kongcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Kongcoin</b> version", 0));
